...
**[Features](#features) • [Get Started](#get-started) • [Documentation](https://homelab.kube.localhost)**
...
[![document](https://img.shields.io/website?label=document&logo=gitbook&logoColor=white&style=flat-square&url=https%3A%2F%2Fhomelab.kube.localhost)](https://homelab.kube.localhost)
...
- [Try it out locally](https://homelab.kube.localhost/installation/sandbox) without any hardware (just 4 commands!)
- [Deploy on real hardware](https://homelab.kube.localhost/installation/production/prerequisites) for production workload

## Roadmap

See [roadmap](https://homelab.kube.localhost/reference/roadmap) and [open issues](https://github.com/khuedoan/homelab/issues) for a list of proposed features and known issues.

## Contributing

Any contributions you make are greatly appreciated.

Please see [contributing guide](https://homelab.kube.localhost/reference/contributing) for more information.
...
See [license page](https://homelab.kube.localhost/reference/license) or `LICENSE.md` file for more information.
